...
public class DataModel {
	...
	public static Map<Integer, BigDecimal> mockTrendStore() {
        Map<Integer, BigDecimal> trendStore = new HashMap<>();
               
        trendStore.put(1, bd(1));
        trendStore.put(2, bd(1.2));
        trendStore.put(3, bd(1));
        trendStore.put(4, bd(1));
        trendStore.put(5, bd(1));
        trendStore.put(6, bd(1));
        trendStore.put(7, bd(1.5));
        trendStore.put(8, bd(1));
        trendStore.put(9, bd(1));
        trendStore.put(10, bd(1));
        trendStore.put(11, bd(0.9));
        trendStore.put(12, bd(0.7));
        trendStore.put(13, bd(1));
        trendStore.put(14, bd(1));
