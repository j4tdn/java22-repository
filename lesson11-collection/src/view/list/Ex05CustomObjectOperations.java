...
public class Ex05CustomObjectOperations {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * Cơ chế: Duyệt từng phần tử trong list, kiểm tra xem có phần tử nào 'equals'
		 * với item hay không Nếu có phần tử equals --> xóa(1 phần tử đầu tiên gặp phải)
		 * 
		 * equals + T chưa override hàm equals --> sử dụng mặc định của Object -> so
		 * sánh == (địa chỉ) + T nên override lại equals để so sánh theo giá trị của các
		 * thuộc tính bên trong T
		 * 
		 * Về nhà: Xem trước cấu trúc dữ liệu + danh sách liên kết đơn + đôi + đa -->
		 * cách khởi tạo, thêm, sửa, xóa, lấy ra ... --> so sánh với mảng
		 * 
		 */
