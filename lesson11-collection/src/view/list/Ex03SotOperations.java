...
public class Ex03SotOperations {
	...
	public static void main(String[] args) {
		...
		// Duyệt bất đồng bộ
		// Đang duyệt đến ptu thứ i vẫn có thể truy cập đến phẩn tử #i
		...
		// Đang duyệt đến ptu thứ i chỉ được phép truy cập phần tử thứ i
		...
		// A12 Z7 C22 W88 D55
		/*
		 * for (String element: elements) { // elements.remove('W88') if
		 * (element.charAt(0) > 'D') { elements.remove(element); } }
		 */

		/*
		 * remove(elements, element -> { char last = element.charAt(element.length() -
		 * 1); return last > '2' && last <= '9'; });
		 */
