...
public class Ex02ArrayListPrinciple {
	...
	public static void main(String[] args) {
		...
		// --> Khi add mới 1 phần tử vào Array --> luôn tạo mảng mới(copy các ptu cũ qua
		// + ptu mới)
		// length

		// ArrayList(Object[] elementData)
		// --> Dùng hàm khởi tạo rỗng(new ArrayList<>()) tạo mảng(elementData) có kích
		// thước là 0
		...
		// --> nếu size chưa vượt quá length của elementData --> đưa phần tử mới đó vào
		// elementData và tăng length 1 đơn vị
		// --> size vượt quá --> grow tạo mảng mới với newLength, copy phần tử củ của
		// elementData đưa sang + null

		// size = 5
		// elemntData.length = 10

		// size: số lượng phần tử của ArrayList(thật sự chưa trong elementData)
		// capacity: sức chứa có thể lưu trữ của ArrayList chính là length của
		// elementData
		...
		// Nếu rồi --> tạo mảng mới vs capacity mới, copy mảng cũ qua, đưa ptu mới vào,
		// tăng size
