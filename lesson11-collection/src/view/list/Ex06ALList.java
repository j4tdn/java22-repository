...
public class Ex06ALList {
	 ...
	 * 
	 * Get/Set ở mọi vị trí: ArrayList > LinkedList
	 * 
	 * Add/Remove 1 phần tử tại vị trí
	 * + 0  (càng về đầu) : ArrayList  < LinkedList  
	 * + n/2(càng về giữa): ArrayList  > LinkedList
	 * + n  (càng về cuối): ArrayList  = LinkedList
	 * 
	 * --> Sử dụng ArrayList hay LinkedList nhiều hơn: 100% ArrayList
	 */
