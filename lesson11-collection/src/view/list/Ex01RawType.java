...
public class Ex01RawType {
	...
	public static void main(String[] args) {
		...
		// l1,l2 là list có thể chứa các phần tử, mỗi phần tử có KDL là Object --> add bất kỳ giá trị KDL nào
		// vấn đề: ko kiểm soát KDL add trong list --> dễ bị lỗi ép kiểu lúc runtime nếu giá trị add vào ko chính xác
		List l1 = new ArrayList(); // cần lưu danh sách các chuỗi
		l1.add("text1");
		l1.add("text2");
		printList14("l1 values", l1);
		
		List l2 = new LinkedList(); // cần lưu danh sách số nguyên
		l2.add(3);
		l2.add(6);
		// l2.add("nam"); runtime error
		printList14("l2 values", l2);
		
		// lấy từng phần tử trong l2 đem * 2 + 1 --> in ra giá trị mới
		...
		// 			   : đặt tên bất kỳ, thường là kí tự đơn viết hoa hoặc tư có nghĩa
