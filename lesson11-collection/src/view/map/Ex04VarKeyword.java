...
public class Ex04VarKeyword {
	...
	public static void main(String[] args) {
		/*
		 * JavaScript: let, var, const let, const: block scope {} var : global function
		 * scope var date = new Date();
		 * 
		 * Java -> ~10
		 * 
		 * Mục đích: Giúp việc khai báo KDL của biến lúc compile gọn hơn
		 * 
		 * Dựa vào giá trị bên phải(sau dấu =) để quy ước KDL của var lúc compile,
		 * runtime
		 * 
		 * Lưu ý: + block scope + dựa vào giá trị bên phải để xác định KDL --> giá trị
		 * khởi tạo ko thể là NULL và cũng ko thể gán null + hạn chế --> làm mất đi khả
		 * năng sử dụng của Đà Hình Trong Đối Tượng --> KDL của var luôn chính xác là
		 * KDL bên phải
		 */
