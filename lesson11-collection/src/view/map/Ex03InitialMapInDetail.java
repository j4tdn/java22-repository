...
public class Ex03InitialMapInDetail {
	...
	public static void main(String[] args) {
		...
		// add, add
		// Arrays.asList(ko thêm, xóa nhưng vẫn sửa)
		// List.of(Imutable list)
		
		// Map<K, V> map = new HashMap<>() ==> TreeMap, LinkedHashMap
		// --> Tạo ra 1 dynamic map, sử dụng put, put để thêm phần tử mới vào
		
		
		// Khởi tạo map kèm entry ban đầu
