...
public class Ex01GenericMethodWithArray {
	...
	// Arrays.sort(Object[] elements) --> Object lúc runtime phải là con của
	// Comparable
	...
	/**
	 * Trong hàm printf -> đang khai báo generic type E E -> nhận giá trị là KDL đối
	 * tượng, phạm vi sử dụng trong hàm printf
	 */
