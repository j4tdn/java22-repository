...
public class Ex01GenericWildCardDemo {
	...
	public static void main(String[] args) {
		// generic type --> T, E ==> khai báo và sử dụng trong generic class, interface,
		// method

		// generic wild card --> ? ==> sử dụng để truyền vào 1 generic class/interface
		// có sẵn

		// tham số là generic type trong class/interface chưa biết truyền vào gì --> ?
		// lúc compile
