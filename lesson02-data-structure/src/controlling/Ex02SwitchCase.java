		...
		*/
		...
		/*
		 ...
		 --> khi điều kiện đúng case
		     + nếu có break --> ngay lập tức thoát khơi swich case block k kiểm tra các case còn lại
		     + nếu ko có break --> ngày vào đoạn code của case đúng
		                       --> bỏ qua việc check điều kiện của các case hiện tại mà nhảy luôn vào body của các case cho đến
		                       khi gặp break hoặc hết defaut, switch case block
