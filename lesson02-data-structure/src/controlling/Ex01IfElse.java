...
public class Ex01IfElse {
	...
	public static void main(String[] args) {
		...
		*/
		...
		// KQ: số ko biết đc số thập phân bao nhiêu, làm tròn 1 chữ số thập phân
		// Nếu điểm mà
		// + [0,5) : yếu
		// + [5, 6.5): trung bình
		// + [6.5, 8): khá
...
//		}
		...
		point = (point > 10) ? 10f : point;
		
		// #,###.#
		// point = 7.8642797f; //7.9
		//point = 7.002f; // 7
		
		// #,###.0 --> luôn luôn tối thiểu và tối đa 1 chữ số thập phân
		// point = 7.8642797f; //7.9
		//point = 7.002f; // 7.0
		...
		//System.out.println("DTB: "+point); //định dạng 1 giá trị KDL ? sang string để in ra
