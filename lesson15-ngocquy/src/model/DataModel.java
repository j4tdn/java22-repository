...
public class DataModel {
	...
	public static Map<Item, List<Store>> mockStoresOfRefItemA55() {
		...
		List<Store> stores = List.of(
				new Store(1, "Store 1", bd(21.9), 2, bd(1)),
				new Store(2, "Store 2", bd(66.9), 1, bd(1.2)),
				new Store(3, "Store 3", bd(10.5), 1, bd(1)),
				new Store(4, "Store 4", bd(36.4), 1, bd(1)),
				new Store(5, "Store 5", bd(14.0), 1, bd(1)),
				new Store(6, "Store 6", bd(65.5), 1, bd(1)),
				new Store(7, "Store 7", bd(17.9), 1, bd(1.5)),
				new Store(8, "Store 8", bd(26.7), 2, bd(1)),
				new Store(9, "Store 9", bd(54.9), 2, bd(1)),
				new Store(10, "Store 10", bd(35.0), 2, bd(1)),
				new Store(11, "Store 11", bd(22.7), 3, bd(0.9)),
				new Store(12, "Store 12", bd(1.0), 3, bd(0.7)),
				new Store(13, "Store 13", bd(19.1), 3, bd(1)),
				new Store(14, "Store 14", bd(19.4), 3, bd(1))
		);
	...
	public static Map<Item, List<Store>> mockStoresOfRefItemA77() {
		...
		List<Store> stores = List.of(
				new Store(1, "Store 1", bd(22.0), 2, bd(1)),
				new Store(2, "Store 2", bd(150.8), 1, bd(1.2)),
				new Store(3, "Store 3", bd(33.4), 1, bd(1)),
				new Store(4, "Store 4", bd(23.4), 1, bd(1)),
				new Store(5, "Store 5", bd(26.3), 1, bd(1)),
				new Store(6, "Store 6", bd(22.2), 1, bd(1)),
				new Store(7, "Store 7", bd(23.6), 2, bd(1.5)),
				new Store(8, "Store 8", bd(21.9), 2, bd(1)),
				new Store(9, "Store 9", bd(20.7), 2, bd(1)),
				new Store(10, "Store 10", bd(0), 2, bd(1)),
				new Store(11, "Store 11", bd(26.6), 3, bd(0.9)),
				new Store(12, "Store 12", bd(0), 3, bd(0.7)),
				new Store(13, "Store 13", bd(32.1), 3, bd(1)),
				new Store(14, "Store 14", bd(22.5), 3, bd(1))
		);
