...
public class Ex02SwapTest {
	public static void main(String[] args) {
		...
		a = a1;//gắn KDL đối tượng cho nguyên thủy --> a1.intValue()
		b1 = b;//gắn KDL nguyên thủy cho đối tượng --> Integer.parseInt(b)
	...
	private static void swapInteger(Integer m, Integer n) {
		   Integer temp = m;
		   m = n;
		   n = temp;
	}
