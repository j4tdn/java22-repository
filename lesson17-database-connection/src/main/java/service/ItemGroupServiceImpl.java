...
public class ItemGroupServiceImpl implements ItemGroupService{
	...
	public List<ItemGroup> getGroupOfItems() {
		...
		Map<ItemGroup, List<Item>> groupsOfItems = items.stream()
								.collect(Collectors.groupingBy(Item::getGroup));
		
		return groupsOfItems.entrySet() 
					.stream()
					.map(entry -> {
