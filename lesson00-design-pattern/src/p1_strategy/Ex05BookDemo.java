...
public class Ex05BookDemo {
	...
	public static void main(String[] args) {
		...
		ReferenceBook rb1 = new ReferenceBook("STK-T1", bd("60"), "Nhi Đồng", bd("5"));
		ReferenceBook rb2 = new ReferenceBook("STK-T2", bd("80"), "Hà Nội", bd("7"));
		ReferenceBook rb3 = new ReferenceBook("STK-T3", bd("70"), "Nhi Đồng", bd("5"));
		ReferenceBook rb4 = new ReferenceBook("STK-T4", bd("90"), "Nhi Đồng", bd("8"));
		ReferenceBook rb5 = new ReferenceBook("STK-T5", bd("50"), "Nhi Đồng", bd("5"));
		...
		// Tìm toàn bộ sách giáo khoa có đơn giá từ 40 đến 80
		result = findBooksBySalesPrice(books, 40, 80);
		generate("3. Sách có đơn giá nhỏ hơn từ 40 -> 80", result);
