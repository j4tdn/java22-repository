...
/**
 * JAVA07 --> java.util.Date: hỗ trợ lưu trữ (1.0) : hầu hết các hàm bị đánh
 * dấu @deprecated (lỗi thời, ko khuyến khích sử dụng)
 * 
 * --> Calendar : hỗ trợ lưu trữ + hàm xử lý (1.1) --> DateFormat : hỗ trợ định
 * dạng dữ liệu
 * 
 * Quy ước: Tháng 0 - 11
 *
...
public class Ex01InitialUtilDate {
	...
	public static void main(String[] args) {
		...
		// new Date(long date) --> long date: số ms tính từ epoch time(1.1.1970 0:0:0
		// GMT)
		// Tương tự số, mốc 0 thì thời gian nó cần một mốc thời gian, được quy ước là
		// unix time, epoch time
		// 1.1.1970 0:0:0 -> nếu chọn mốc thời gian thời gian 0.0.0 0:0:0 thì 1 lần tính
		// toán
		// đến thời gian hiện tại đơn vị ms rất là lớn k có KDL, vùng nhớ nào có thể lưu
		// trữ
