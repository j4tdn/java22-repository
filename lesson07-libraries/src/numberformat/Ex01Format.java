...
public class Ex01Format {
	...
	public static void main(String[] args) {
		...
		double value = 564271218869913425352182023456789d;
		...
		BigDecimal bd1 = new BigDecimal(String.valueOf("564271218869913425352182023456789")).abs(MathContext.DECIMAL64);
		System.out.println("\nbd1: " + bd1); // 
		System.out.println("bd1 plain string: " + bd1.toPlainString()); // format
		
		BigDecimal bd2 = new BigDecimal(String.valueOf("564271218869913425352182023456789")).abs(MathContext.DECIMAL128);
		System.out.println("bd1 128 plain string: " + bd2.toPlainString()); // format
