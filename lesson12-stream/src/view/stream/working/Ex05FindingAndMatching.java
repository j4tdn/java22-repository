...
public class Ex05FindingAndMatching {
	/*
	 Example: Give a list of numbers: 1, 2, 1, 4, 5, 8, 101, 4, 12
		...
		New Data Type: Optional<T> hạn chế xảy ra NullPointerException
		Optional
		 T
		 --> ifPresent(Consumer<T> consumer), isPresent
		 --> isAbsent(Consumer<T> consumer), isAbsent
	...
	*/	
	...
	public static void main(String[] args) {
		var numbers = List.of(1, 2, 1, 4, 5, 8, 101, 4, 12);
