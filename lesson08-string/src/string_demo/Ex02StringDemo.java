...
public class Ex02StringDemo {
	public static void main(String[] args) {
		...
		System.out.println("Kiểm tra chuỗi s1 có phải là chuỗi bắt đầu của s hay không --> " + s.startsWith(s1));
		System.out.println("Kiểm tra chuỗi s1 có phải là chuỗi kết thúc của s hay không --> " + s.endsWith(s1));
		...
		// Phân biệt StringBuilder và StringBuffer --> Video
	}
