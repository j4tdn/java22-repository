...
public class Ex02StringImmutableExplain {
	...
	public static void main(String[] args) {
		...
		// Kiểm tra trên HEAP, constant pool xem thử có ô nhớ nào mang giá trị "table" chưa
		...
		//string constant pool: là vùng nhớ ở HEAP tại đó các ô nhớ trong constant pool không trùng nhau
