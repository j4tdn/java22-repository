...
public class Ex03StringCompare {
	...
	/*
	 * So sánh 2 chuỗi (2 biến KDL chuỗi ) + Để so sánh 2 biến có KDL bất kì, nếu
	 * dùng toán tử == != >= <= --> chỉ so sánh giá trị ở vùng nhớ stack + Nếu KDL
	 * nguyên thuỷ : STACK lưu trữ giá trị của biến + Nếu KDL đối tượng : STACK lưu
	 * trữ giá trị của biến int a = 5; int b = 7;
	 * 
	 * boolean val = (a == b) --> so sánh giá trị 5 và 7
	 * 
	 * String s1 = "hello"; String s2 = "xinchao";
	 */
