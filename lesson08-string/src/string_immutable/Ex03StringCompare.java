...
public class Ex03StringCompare {
	...
	/*
	 ...
	 + Nếu KDL đối tượng: STACK lưu trữ dịa chỉ của biến
	 int a = 5;
	 int b = 7;
	...
	public static void main(String[] args) {
		...
		// Với String class con của Object, Compareable
		// Nên có thể sử dụng hàm equals, compareTo để so sánh giá trị chuỗi
		...
		System.out.println("s1.compareTo(s3) --> " + s1.compareTo(s3)); //-8
		System.out.println("s2.compareTo(s4) --> " + s2.compareTo(s4)); //-23
	}
