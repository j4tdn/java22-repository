...
public class Ex01Demo {
	...
	public static void main(String[] args) {
		...
		// anonymous function: function ko có tên -> bắt đầu xuất hiện từ java8
		...
		// Cách 2: Tạo implements class, implements từ interface
		...
		// Vì sao chỉ có thể khởi tạo đối tượng cho functional interface ?

		// --> Vì cấu trúc của lambda là (tham số) -> {body}
		// Một lambda chỉ override được duy nhất 1 hàm trừu tượng bên trong functional
		// interface
		// Nếu functional interface có nhiều hơn 1 hàm trừu tượng -> lambda ko thể
		// override các hàm trừu tượng đó

		// Mà ko thể khởi tạo đối tượng cho một interface bất kỳ(có thể có nhiều hơn 1
		// hàm trừu tượng)

		// Lambda là gì?
		// Lambda(anonymous function) là cách viết ngắn gọn để khởi tạo đối tượng cho
