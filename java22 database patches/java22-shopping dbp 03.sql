...
--     CONSTRAINT UNQ_T100_ITEM_SUPPLIER_NAME UNIQUE(C100_SUPPLIER_NAME),
--     CONSTRAINT UNQ_T100_ITEM_SUPPLIER_TAX UNIQUE(C100_SUPPLIER_TAX)
-- );
...
-- 	CONSTRAINT FK_T101_T100 FOREIGN KEY (C101_SUPPLIER_ID) 
-- 						  REFERENCES T100_SUPPLIER(C100_SUPPLIER_ID),
--                           
--     CONSTRAINT FK_T101_T01 FOREIGN KEY (C101_ITEM_ID) 
