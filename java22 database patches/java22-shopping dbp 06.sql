...
-- C04_DELIVERY_ADDRESS VARCHAR(255) NOT NULL,
-- C04_PAYMENT_METHOD_ID INT NOT NULL,
-- C04_ORDER_TIME TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
-- C04_CUSTOMER_ID INT NOT NULL,
-- CONSTRAINT FK_T04_PM_METHOD_ID_CHECK FOREIGN KEY (C04_PAYMENT_METHOD_ID) 
-- 						  REFERENCES T09_PAYMENT_METHOD(C09_PM_ID),
-- CONSTRAINT FK_T04_CUSTOMER_ID_CHECK FOREIGN KEY (C04_CUSTOMER_ID) 
-- 						  REFERENCES T08_CUSTOMER(C08_CUSTOMER_ID)
-- );

-- CREATE TABLE T05_ORDER_DETAIL(
-- C05_ORDER_ID INT PRIMARY KEY AUTO_INCREMENT,
-- C05_ITEM_DETAIL_ID INT NOT NULL,
-- C05_AMOUNT INT NOT NULL,
-- CONSTRAINT FK_T05_ITEM_DETAIL_ID_CHECK FOREIGN KEY (C05_ITEM_DETAIL_ID) 
-- 						  REFERENCES T03_ITEM_DETAIL(C03_ITEM_DETAIL_ID)
...
-- C06_LAST_UPDATED TIMESTAMP DEFAULT CURRENT_TIMESTAMP

-- );

-- CREATE TABLE T07_BILL(
-- C07_BILL_ID INT PRIMARY KEY AUTO_INCREMENT,
-- C07_DELIVERY_FEE INT NOT NULL,
-- C07_TOTAL_OF_MONEY INT NOT NULL,
-- C07_ORDER_ID INT NOT NULL,
-- CONSTRAINT FK_T07_ORDER_ID_CHECK FOREIGN KEY (C07_ORDER_ID) 
-- 						  REFERENCES T04_ORDER(C04_ORDER_ID)
