...
-- C08_CUSTOMER_PASSWORD VARCHAR(255) NOT NULL,
...
-- C13_EMPLOYEE_EMAIL VARCHAR(255) NOT NULL,
-- C13_EMPLOYEE_ADDRESS VARCHAR(255) NOT NULL,
-- C13_EMPLOYEE_PHONE VARCHAR(255) NOT NULL,
-- C13_EMPLOYEE_PASSWORD VARCHAR(255) NOT NULL,
-- C13_TITLE_ID INT NOT NULL,
-- CONSTRAINT UNQ_T13_EMPLOYEE UNIQUE(C13_EMPLOYEE_EMAIL, C13_EMPLOYEE_PHONE),
-- CONSTRAINT FK_T13_T11 FOREIGN KEY (C13_TITLE_ID) 
-- 						  REFERENCES T11_TITLE(C11_TITLE_ID)
-- );
