...
-- Các bảng: T01_ITEM, T02_ITEM_GROUP, T03_ITEM_DETAIL, T12_SIZE

-- Sử dụng cơ sở dữ liệu java22_shopping
USE java22_shopping;
...
CREATE TABLE T02_ITEM_GROUP (
    ...
    CONSTRAINT UNQ_T02_GROUP_NAME UNIQUE (C02_ITEM_GROUP_NAME)
);
