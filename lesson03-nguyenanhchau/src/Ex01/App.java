...
public class App {
	...
	public static void main(String[] args) {
		...
		Customer c2 = new Customer("KH2", "Kate", "342", "Japan");
        ...
        System.out.println("Order 1: " + OrderStatic.export(o1));
		
		System.out.println("Order 2: " + OrderStatic.export(o2));

		System.out.println("Order 3: " + OrderStatic.export(o3));
