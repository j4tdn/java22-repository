...
public class DataModel {
	...
	public static Item[] mockItemsWithNullObject() {
		return new Item[] {
		    null,
			new Item(1, "Item A1", 222D, of("16/05/2024")),
			new Item(8, "Item C8", 18D, of("12/05/2024")),
	...
	public static Item[] mockItemsWithNullAtributes() {
		return new Item[] {
			new Item(1, "Item A1", 222D, of("16/05/2024")),
			new Item(8, "Item C8", 18D, of("12/05/2024")),
			new Item(2, "Item B2", null, of("15/05/2024")),
			new Item(4, "Item K4", 222D, of("18/05/2024")),
			new Item(10, "Item Z19", null, of("30/08/2024")),
			new Item(18, "Item T18", 22D, of("27/01/2024")),
			new Item(32, "Item A32", 333D, null),
			new Item(7, "Item Y7", 432D, of("11/01/2023"))
		};
	}
