...
public class Ex02Test02 {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 + Tìm các phần tử có giá trị lớn nhất trong mảng
		 + Tìm các phần tử có giá trị nhỏ nhất trong mảng
	...
	private static int process(int inital, int[] elements, Operator operator ) {
		int result = inital;
