...
public class Ex02Test02 {
	...
	public static void main(String[] args) {
		...
		/*
		 * Viết chương trình thực hiện + Tìm tổng các phần tử trong mảng + Tìm tích các
		 * phần tử trong mảng + Tìm phần tử có giá trị lớn nhất trong mảng + Tìm phần tử
		 * có giá trị nhỏ nhất trong mảng Yêu cầu: Kết quả trả về là 1 số nguyên
		 */
	...
	/*
	 * sum = sum + element; mul = mul * element; min = min > element ? element :
	 * min; max = max < element ? element : max;
	 * 
	 * --> input: là 2 số nguyên --> output: là 1 số nguyên
	 * 
	 */
