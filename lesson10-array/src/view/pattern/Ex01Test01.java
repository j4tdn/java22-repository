...
public class Ex01Test01 {
	public static void main(String[] args) {
		...
		/*
		 ...
		 + Tìm các phân tử chẵn trong mảng
		 + Tìm các phân tử lẻ trong mảng
		 + Tìm các phân tử là số nguyên tố trong mảng
		 + Tìm các phân tử là số hành phúc trong mảng
		...
		System.out.println("oddElements --> " + Arrays.toString(oddElements));
		System.out.println("primeElements --> " + Arrays.toString(primeElements));
		System.out.println("happyElements --> " + Arrays.toString(happyElements));
