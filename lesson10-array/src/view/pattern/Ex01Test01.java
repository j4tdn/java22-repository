...
public class Ex01Test01 {
	...
	public static void main(String[] args) {
		...
		/*
		 * Viết chương trình thực hiện + Tìm các phần tử chẵn trong mảng + Tìm các phần
		 * tử lẻ trong mảng + Tìm các phần tử là số nguyên tố trong mảng + Tìm các phần
		 * tử là số hạnh phúc trong mảng
		 * 
	...
	/*
	 * + isPrime(number) + number % 2 != 0 + number % 2 == 0 + isHappy(number) -->
	 * input: là 1 số --> output: là 1 boolean ==> interface: boolean test(int
	 * number)
	 * 
	 */
