...
public class Ex02ArrayOperations {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * + Thêm mới một phần tử vào vị trí thứ k vào mảng (0 < k < length)
		 * 
		 * + Xóa một phần từ tại vị trí thứ k trong mảng (0 < k < length)
		 */
		...
		System.out.println("elements delete(source, 2) --> " + Arrays.toString(delete(elements, 2)));
	}
	...
	private static void modify(int[] elements) {
		elements[3] = 555; // setter
		elements = new int[5]; // no affect to source elements
	}
