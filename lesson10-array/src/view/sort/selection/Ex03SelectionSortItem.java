...
public class Ex03SelectionSortItem {
	...
	public static void main(String[] args) {
		...
		selectionSort(items, (i1 ,i2) -> {
			...
			// khi sp1 >< sp2 -> return +- hoán vị tăng dần, giảm dần
			if(salesPriceInt !=0 ) {
				return salesPriceInt;
			}
			
			// sp1 = sp2 --> cân nhắc đến salesDate
			// khi salesPrice bằng nhau, giảm dần theo salesDate
		...
		selectionSort(items, (i1 ,i2) -> {
			// Giảm dần theo salesDate
			LocalDate sd1 = i1.getSalesDate();
			LocalDate sd2 = i2.getSalesDate();
			int salesPriceInt = sd2.compareTo(sd1);
		...
		printf("6. Null First, Tăng dần theo name", itemWithNullObjects);
	}
