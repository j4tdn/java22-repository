...
public class ItemStoreRel {
	...
	referencedColumnName = "C17_STORE_ID")
	private Store store;
	
	@ManyToOne(fetch = FetchType.LAZY)
	@JoinColumn(name = "C18_ITEM_ID", 
	referencedColumnName = "C01_ITEM_ID")
	private Item item;
	...
	public String toString() {
		return "ItemStoreRel [id=" + id + ", store=" + store + ", item=" + item + ", amountOfItems=" + amountOfItems
	...
	public static class Id{
		@Column(name = "C18_STORE_ID", 
				insertable = false, updatable = false)
		private Integer storeId;
		
		@Column(name = "C18_ITEM_ID",
				insertable = false, updatable = false)
