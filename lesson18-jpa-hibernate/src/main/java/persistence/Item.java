...
public class Item {
	...
	@Id
	@Column(name = "C01_ITEM_ID", nullable = false)
	private Integer id;
	
	@Column(name = "C01_ITEM_NAME")
	private String name; 
	
	// Mapping mối quan hệ N-1 giữa Item và ItemGroup(phải là 1 entity)
	// Khái niệm fetchType(eager, lazy)
	
	// Với @ManyToOne mặc đinh fetchType = eager
