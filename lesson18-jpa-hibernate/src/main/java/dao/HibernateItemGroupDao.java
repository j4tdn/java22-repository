...
public class HibernateItemGroupDao extends GenericDao implements ItemGroupDao{
	...
	/*
	 Với các thào tác liên quan đến cập nhật dữ liệu
	 Thêm - Sửa - Xóa
	 --------
	...
	public void delete(Set<Integer> groupIds) {
	    openSession().doWork(connection -> {
	        try (var pst = connection.prepareStatement(Q_DELETE_ITEM_GROUP_BY_ID)) {
	            int batchCount = 0;
	...
	@Override
	public List<ItemGroupDto> statisticItemGroupDetail() {
