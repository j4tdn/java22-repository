...
public class Ex02StaticAttributeDemo {
	...
	public static void main(String[] args) {
		//Tạo ra 1000 mẫu xe Audi với màu sắc khác nhau
		//Tạo ra 10 (demo)
		
		//Tạo ra KDL Car dùng để quản lý xe cho hãng Audi
		
		Car c01 = new Car("01", "Audi", "Yellow", 800d); //H1
		Car c02 = new Car("02", "Audi", "Red", 800d); //H2
		Car c03 = new Car("03", "Audi", "Blue", 800d); //H3
		Car c04 = new Car("04", "Audi", "Green", 800d); //H4
		Car c05 = new Car("05", "Audi", "Yellow", 800d); //H5
		Car c0k = new Car("0k", "Audi", "Yellow", 800d); //H6
		Car c10 = new Car("10", "Audi", "Yellow", 800d); //H7
		...
		// cho tất cả các đối tượng được tạo ra từ 1 class
		...
		//2. Chuyển đỏi tên hãng xe từ Audi sang MG
