...
public class Ex02StaticAttributeDemo {
	...
	public static void main(String[] args) {
		...
		// Tất cả các car khi tạo ra đều có model = Audi
		// Thay vì lưu trữ mỗi đối tượng(ô nhớ) quản lý 1 thông tin model riêng
		
		// + tốn vùng nhớ cho những giá trị trùng nhau của tất cả đối tượng ở class
		// + tất cả đối tượng mang giá trị model chung, nếu cập nhật giá trị model
		//	--> phải cập nhật cho tất cả, thiếu --> bug
		
		// IDEA:: Nếu như thuộc tính(thông tin) nào mà là thông tin chung
		// cho tất cả các đối tượng trong 1 class
		
		// --> nên cho thuộc tính đó là static
		// --> thuộc tính static --> nó sẽ lưu trữ ở 1 ô nhớ riêng
		// --> tất cả các đối tượng từ class đều dùng chung ô nhớ này thay vì lưu riêng
